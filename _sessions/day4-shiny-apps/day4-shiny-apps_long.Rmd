...
As Shiny apps are all about interactivity, you will want to use interactive plots. Check the following [webpage](https://r-graph-gallery.com/interactive-charts.html) for a examples of packages that have interactivity. I will show a few common ones below:
