...
![](images/shiny_serverside.png){width="50%"}
...
![](images/server_cheatsheet_box.png)
...
_Possible steps:_
1)  Decide on what outputs you want to show
2)  How does the user interact with the app?
3)  Based on the outputs, which layout works best for you?  Go to shiny layouts to pick one or try AI
4)  
