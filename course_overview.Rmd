...
```{r out.width='100%', out.height='200%', echo=F}
...
The goal here is not to make you a programmer but familiar with a few key tools so that you can tinker away.
...
Just a reminder QEARI (**Q**uantitative **E**cology **ARI**) is a great resource and a safe place for asking "dumb" questions. The amount expertise among its regulars is impressively! There are multiple channels to ask questions including a **new one for shiny Apps**!!!
